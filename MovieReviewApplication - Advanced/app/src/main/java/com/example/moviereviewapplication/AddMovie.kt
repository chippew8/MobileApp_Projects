    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        if (item?.itemId == R.id.addMovie){
            if (ErrorValidation()) {
                ...
                mc.addToDatabase(movieName,movieDesc, movieLang, movieRelease, suitable, reason1.toString(), reason2.toString(), rating.toString(), review.toString(), applicationContext)
                var m = MovieClass(movieName, movieDesc, movieLang, movieRelease, suitable, reason1, reason2, rating, review)
